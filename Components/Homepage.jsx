...
const Homepage = () => {
  return (
    ...
    <div className='h-screen md:flex md:justify-between md:relative md:items-center md:mt-10 mt-24 overflow-y-hidden' id="home">
      ...
      <div className='hidden sm:absolute md:absolute bg-purple-300 right-40 top-80 rounded-full w-80 h-80 filter blur-3xl opacity-30 animate-blob' ></div>
      <div className='hidden sm:absolute md:absolute bg-yellow-600 right-20 top-100 rounded-full w-72 h-72 filter blur-3xl opacity-20 animate-blob'></div>
      <div className='hidden sm:absolute md:absolute bg-purple-600 right-52 top-50 rounded-full w-72 h-72 filter blur-3xl opacity-30 animate-blob'></div>
