...
const Post = () => {
  return (
    <div class="flex md:flex-col bg-gray-800 hover:bg-black border rounded-xl shadow-md overflow-hidden md:max-w-2xl">
    ...
    <a href="#">
        <h5 class="dark:text-white text-gray-900 font-bold md:text-2xl text-xl tracking-tight mb-2">Noteworthy technology</h5>
    </a>
